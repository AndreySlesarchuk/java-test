...
/**
 * Factory which implements the Flyweight pattern to return an existing vehicle if present or a new
 * one otherwise.
 *
...
public class VehicleFactory {
  ...
  /**
   * Returns a vehicle of the same color passed as argument. If that vehicle was already created by
   * this factory, that vehicle is returned, otherwise a new one is created and returned.
   *
