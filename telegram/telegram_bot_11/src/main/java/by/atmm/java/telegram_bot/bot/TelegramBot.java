package by.atmm.java.telegram_bot.bot;
...
public class TelegramBot extends TelegramLongPollingBot {
  ...
  public TelegramBot(@Value("${telegram.bot.token}") String botToken, Environment env, TelegramBotService telegramBotService, MailService mailService) {
    super(botToken);
    this.env = env;
