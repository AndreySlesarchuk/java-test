...
public class PDF2HTMLExample {
  ...
  private static final String PDF = INPUT_DIR + "pdf.pdf";
  private static final String HTML = INPUT_DIR + "html.html";
  ...
  public static void main(String[] args) {
    try {
      ...
      generatePDFFromHTML(HTML);
        ...
        IOException | ParserConfigurationException | DocumentException e) {
      e.printStackTrace();
    }
  }
  ...
  private static void generateHTMLFromPDF(String filename)
    ...
    Writer output = new PrintWriter(OUTPUT_DIR + "pdf.html", "utf-8");
  ...
  private static void generatePDFFromHTML(String filename)
    ...
    PdfWriter writer = PdfWriter.getInstance(document,
        new FileOutputStream(OUTPUT_DIR + "html.pdf"));
    document.open();
