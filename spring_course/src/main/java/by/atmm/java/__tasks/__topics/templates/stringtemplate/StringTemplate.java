package by.atmm.java.__tasks.__topics.templates.stringtemplate;
...
public class StringTemplate {
  ...
  public static void main(String[] args) {
    ...
    by.atmm.java.__tasks.__topics.templates.stringtemplate.StrSubstitutor sub = new by.atmm.java.__tasks.__topics.templates.stringtemplate.StrSubstitutor(valuesMap);
