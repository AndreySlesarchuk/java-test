package by.atmm.java.__tasks.__topics.collections;
...
public class CollectRequest {
  ...
  public String findProductExpenditures(Long companyId, Long staffId, Long clientId,
    ...
    final String CLIENT =
        clientId != null ? getQueryPart("clientId", clientId, ++parameterNum) : "";
    final String STOREHOUSE_PRODUCT_EXPENDITURE = getQueryPart("storehouseProductExpenditureId",
        storehouseProductExpenditureId, ++parameterNum);
    final String STOREHOUSE_PRODUCT = getQueryPart("storehouseProductId", storehouseProductId,
        ++parameterNum);
    final String APPOINTMENT = getQueryPart("appointmentId", appointmentId, ++parameterNum);

    String requestString =
        BASE_QUERY + STAFF + CLIENT + STOREHOUSE_PRODUCT_EXPENDITURE + STOREHOUSE_PRODUCT
            + APPOINTMENT;
