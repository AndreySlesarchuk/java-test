package by.atmm.java.__early.__other.templates.stringtemplate;
...
public class StringTemplate {
  ...
  public static void main(String[] args) {
    ...
    by.atmm.java.__early.__other.templates.stringtemplate.StrSubstitutor sub = new by.atmm.java.__early.__other.templates.stringtemplate.StrSubstitutor(valuesMap);
