...
public class CollectRequest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("First - " + new CollectRequest().findProductExpenditures(1L, 2L, 3L, 4L, 5L, 6L));


    }

    public String findProductExpenditures(Long companyId, Long staffId, Long clientId, Long storehouseProductExpenditureId, Long storehouseProductId, Long appointmentId) {

        StringBuilder baseQuery = new StringBuilder("select s from ProductExpenditure s where s.staff.company = ?1");
